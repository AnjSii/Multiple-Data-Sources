...
import com.anj.test.config.source.DataSourceSwitchMethodInterceptor;
...
@Getter
@Configuration
@ConfigurationProperties(prefix = "anj.test.transactional")
public class TransactionalConfig {
	 ...
	 * @param transactionInterceptor : {@link #customizeTransactionInterceptor(PlatformTransactionManager)}
	 ...
	 pointcut.setExpression( "execution (* com.anj.test.*.*service.*.*(..))" );
	 return pointcut;
	 }
	 */
